						    ...
						    <tr>
						        <th>
						        	<form action="<%=request.getContextPath()%>/ProfessorServlet" method="post">
										...
										<button type="submit" value="Confirm Reservations" name="action" class="sortButton">Student Id</button>
									</form>
								</th>
								<th colspan=2>
									<form action="<%=request.getContextPath()%>/ProfessorServlet" method="post">
										<input type="hidden" name="alignment" value="3">
										<button type="submit" value="Confirm Reservations" name="action" class="sortButton">Date / Time</button>
									</form>
								</th>
								<th>Room</th>
								<th>
									<form action="<%=request.getContextPath()%>/ProfessorServlet" method="post">
										...
										<button type="submit" value="Confirm Reservations" name="action" class="sortButton">Priority</button>
									</form>
								</th>
								<th>Comment</th>
								<th>Actions</th>
